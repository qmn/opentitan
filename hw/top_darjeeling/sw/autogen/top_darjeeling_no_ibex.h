...
#ifndef OPENTITAN_SW_AUTOGEN_TOP_DARJEELING_NO_IBEX_H_
#define OPENTITAN_SW_AUTOGEN_TOP_DARJEELING_NO_IBEX_H_
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_NO_IBEX_RV_TIMER_BASE_ADDR 0x30100000u

/**
 * Peripheral size for rv_timer in top darjeeling_no_ibex.
 *
 * This is the size (in bytes) of the peripheral's reserved memory area. All
 * memory-mapped registers associated with this peripheral should have an
 * address between #TOP_DARJEELING_NO_IBEX_RV_TIMER_BASE_ADDR and
 * `TOP_DARJEELING_NO_IBEX_RV_TIMER_BASE_ADDR + TOP_DARJEELING_NO_IBEX_RV_TIMER_SIZE_BYTES`.
 */
#define TOP_DARJEELING_NO_IBEX_RV_TIMER_SIZE_BYTES 0x200u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_NO_IBEX_RV_DM_REGS_BASE_ADDR 0x21200000u

/**
 * Peripheral size for regs device on rv_dm in top darjeeling_no_ibex.
 *
 * This is the size (in bytes) of the peripheral's reserved memory area. All
 * memory-mapped registers associated with this peripheral should have an
 * address between #TOP_DARJEELING_NO_IBEX_RV_DM_REGS_BASE_ADDR and
 * `TOP_DARJEELING_NO_IBEX_RV_DM_REGS_BASE_ADDR + TOP_DARJEELING_NO_IBEX_RV_DM_REGS_SIZE_BYTES`.
 */
#define TOP_DARJEELING_NO_IBEX_RV_DM_REGS_SIZE_BYTES 0x10u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_NO_IBEX_RV_DM_MEM_BASE_ADDR 0x40000u

/**
 * Peripheral size for mem device on rv_dm in top darjeeling_no_ibex.
 *
 * This is the size (in bytes) of the peripheral's reserved memory area. All
 * memory-mapped registers associated with this peripheral should have an
 * address between #TOP_DARJEELING_NO_IBEX_RV_DM_MEM_BASE_ADDR and
 * `TOP_DARJEELING_NO_IBEX_RV_DM_MEM_BASE_ADDR + TOP_DARJEELING_NO_IBEX_RV_DM_MEM_SIZE_BYTES`.
 */
#define TOP_DARJEELING_NO_IBEX_RV_DM_MEM_SIZE_BYTES 0x1000u
...
typedef enum top_darjeeling_no_ibex_plic_peripheral {
  ...
  kTopDarjeelingNoIbexPlicPeripheralRvTimer = 5, /**< rv_timer */
  kTopDarjeelingNoIbexPlicPeripheralOtpCtrl = 6, /**< otp_ctrl */
  kTopDarjeelingNoIbexPlicPeripheralAlertHandler = 7, /**< alert_handler */
  kTopDarjeelingNoIbexPlicPeripheralSpiHost0 = 8, /**< spi_host0 */
  kTopDarjeelingNoIbexPlicPeripheralPwrmgrAon = 9, /**< pwrmgr_aon */
  kTopDarjeelingNoIbexPlicPeripheralAonTimerAon = 10, /**< aon_timer_aon */
  kTopDarjeelingNoIbexPlicPeripheralSocProxy = 11, /**< soc_proxy */
  kTopDarjeelingNoIbexPlicPeripheralHmac = 12, /**< hmac */
  kTopDarjeelingNoIbexPlicPeripheralKmac = 13, /**< kmac */
  kTopDarjeelingNoIbexPlicPeripheralOtbn = 14, /**< otbn */
  kTopDarjeelingNoIbexPlicPeripheralKeymgrDpe = 15, /**< keymgr_dpe */
  kTopDarjeelingNoIbexPlicPeripheralCsrng = 16, /**< csrng */
  kTopDarjeelingNoIbexPlicPeripheralEntropySrc = 17, /**< entropy_src */
  kTopDarjeelingNoIbexPlicPeripheralEdn0 = 18, /**< edn0 */
  kTopDarjeelingNoIbexPlicPeripheralEdn1 = 19, /**< edn1 */
  kTopDarjeelingNoIbexPlicPeripheralDma = 20, /**< dma */
  kTopDarjeelingNoIbexPlicPeripheralMbx0 = 21, /**< mbx0 */
  kTopDarjeelingNoIbexPlicPeripheralMbx1 = 22, /**< mbx1 */
  kTopDarjeelingNoIbexPlicPeripheralMbx2 = 23, /**< mbx2 */
  kTopDarjeelingNoIbexPlicPeripheralMbx3 = 24, /**< mbx3 */
  kTopDarjeelingNoIbexPlicPeripheralMbx4 = 25, /**< mbx4 */
  kTopDarjeelingNoIbexPlicPeripheralMbx5 = 26, /**< mbx5 */
  kTopDarjeelingNoIbexPlicPeripheralMbx6 = 27, /**< mbx6 */
  kTopDarjeelingNoIbexPlicPeripheralMbxJtag = 28, /**< mbx_jtag */
  kTopDarjeelingNoIbexPlicPeripheralMbxPcie0 = 29, /**< mbx_pcie0 */
  kTopDarjeelingNoIbexPlicPeripheralMbxPcie1 = 30, /**< mbx_pcie1 */
  kTopDarjeelingNoIbexPlicPeripheralRaclCtrl = 31, /**< racl_ctrl */
  kTopDarjeelingNoIbexPlicPeripheralAcRangeCheck = 32, /**< ac_range_check */
  kTopDarjeelingNoIbexPlicPeripheralLast = 32, /**< \internal Final PLIC peripheral */
...
typedef enum top_darjeeling_no_ibex_plic_irq_id {
  ...
  kTopDarjeelingNoIbexPlicIrqIdRvTimerTimerExpiredHart0Timer0 = 65, /**< rv_timer_timer_expired_hart0_timer0 */
  kTopDarjeelingNoIbexPlicIrqIdOtpCtrlOtpOperationDone = 66, /**< otp_ctrl_otp_operation_done */
  kTopDarjeelingNoIbexPlicIrqIdOtpCtrlOtpError = 67, /**< otp_ctrl_otp_error */
  kTopDarjeelingNoIbexPlicIrqIdAlertHandlerClassa = 68, /**< alert_handler_classa */
  kTopDarjeelingNoIbexPlicIrqIdAlertHandlerClassb = 69, /**< alert_handler_classb */
  kTopDarjeelingNoIbexPlicIrqIdAlertHandlerClassc = 70, /**< alert_handler_classc */
  kTopDarjeelingNoIbexPlicIrqIdAlertHandlerClassd = 71, /**< alert_handler_classd */
  kTopDarjeelingNoIbexPlicIrqIdSpiHost0Error = 72, /**< spi_host0_error */
  kTopDarjeelingNoIbexPlicIrqIdSpiHost0SpiEvent = 73, /**< spi_host0_spi_event */
  kTopDarjeelingNoIbexPlicIrqIdPwrmgrAonWakeup = 74, /**< pwrmgr_aon_wakeup */
  kTopDarjeelingNoIbexPlicIrqIdAonTimerAonWkupTimerExpired = 75, /**< aon_timer_aon_wkup_timer_expired */
  kTopDarjeelingNoIbexPlicIrqIdAonTimerAonWdogTimerBark = 76, /**< aon_timer_aon_wdog_timer_bark */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal0 = 77, /**< soc_proxy_external 0 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal1 = 78, /**< soc_proxy_external 1 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal2 = 79, /**< soc_proxy_external 2 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal3 = 80, /**< soc_proxy_external 3 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal4 = 81, /**< soc_proxy_external 4 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal5 = 82, /**< soc_proxy_external 5 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal6 = 83, /**< soc_proxy_external 6 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal7 = 84, /**< soc_proxy_external 7 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal8 = 85, /**< soc_proxy_external 8 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal9 = 86, /**< soc_proxy_external 9 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal10 = 87, /**< soc_proxy_external 10 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal11 = 88, /**< soc_proxy_external 11 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal12 = 89, /**< soc_proxy_external 12 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal13 = 90, /**< soc_proxy_external 13 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal14 = 91, /**< soc_proxy_external 14 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal15 = 92, /**< soc_proxy_external 15 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal16 = 93, /**< soc_proxy_external 16 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal17 = 94, /**< soc_proxy_external 17 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal18 = 95, /**< soc_proxy_external 18 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal19 = 96, /**< soc_proxy_external 19 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal20 = 97, /**< soc_proxy_external 20 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal21 = 98, /**< soc_proxy_external 21 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal22 = 99, /**< soc_proxy_external 22 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal23 = 100, /**< soc_proxy_external 23 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal24 = 101, /**< soc_proxy_external 24 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal25 = 102, /**< soc_proxy_external 25 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal26 = 103, /**< soc_proxy_external 26 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal27 = 104, /**< soc_proxy_external 27 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal28 = 105, /**< soc_proxy_external 28 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal29 = 106, /**< soc_proxy_external 29 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal30 = 107, /**< soc_proxy_external 30 */
  kTopDarjeelingNoIbexPlicIrqIdSocProxyExternal31 = 108, /**< soc_proxy_external 31 */
  kTopDarjeelingNoIbexPlicIrqIdHmacHmacDone = 109, /**< hmac_hmac_done */
  kTopDarjeelingNoIbexPlicIrqIdHmacFifoEmpty = 110, /**< hmac_fifo_empty */
  kTopDarjeelingNoIbexPlicIrqIdHmacHmacErr = 111, /**< hmac_hmac_err */
  kTopDarjeelingNoIbexPlicIrqIdKmacKmacDone = 112, /**< kmac_kmac_done */
  kTopDarjeelingNoIbexPlicIrqIdKmacFifoEmpty = 113, /**< kmac_fifo_empty */
  kTopDarjeelingNoIbexPlicIrqIdKmacKmacErr = 114, /**< kmac_kmac_err */
  kTopDarjeelingNoIbexPlicIrqIdOtbnDone = 115, /**< otbn_done */
  kTopDarjeelingNoIbexPlicIrqIdKeymgrDpeOpDone = 116, /**< keymgr_dpe_op_done */
  kTopDarjeelingNoIbexPlicIrqIdCsrngCsCmdReqDone = 117, /**< csrng_cs_cmd_req_done */
  kTopDarjeelingNoIbexPlicIrqIdCsrngCsEntropyReq = 118, /**< csrng_cs_entropy_req */
  kTopDarjeelingNoIbexPlicIrqIdCsrngCsHwInstExc = 119, /**< csrng_cs_hw_inst_exc */
  kTopDarjeelingNoIbexPlicIrqIdCsrngCsFatalErr = 120, /**< csrng_cs_fatal_err */
  kTopDarjeelingNoIbexPlicIrqIdEntropySrcEsEntropyValid = 121, /**< entropy_src_es_entropy_valid */
  kTopDarjeelingNoIbexPlicIrqIdEntropySrcEsHealthTestFailed = 122, /**< entropy_src_es_health_test_failed */
  kTopDarjeelingNoIbexPlicIrqIdEntropySrcEsObserveFifoReady = 123, /**< entropy_src_es_observe_fifo_ready */
  kTopDarjeelingNoIbexPlicIrqIdEntropySrcEsFatalErr = 124, /**< entropy_src_es_fatal_err */
  kTopDarjeelingNoIbexPlicIrqIdEdn0EdnCmdReqDone = 125, /**< edn0_edn_cmd_req_done */
  kTopDarjeelingNoIbexPlicIrqIdEdn0EdnFatalErr = 126, /**< edn0_edn_fatal_err */
  kTopDarjeelingNoIbexPlicIrqIdEdn1EdnCmdReqDone = 127, /**< edn1_edn_cmd_req_done */
  kTopDarjeelingNoIbexPlicIrqIdEdn1EdnFatalErr = 128, /**< edn1_edn_fatal_err */
  kTopDarjeelingNoIbexPlicIrqIdDmaDmaDone = 129, /**< dma_dma_done */
  kTopDarjeelingNoIbexPlicIrqIdDmaDmaChunkDone = 130, /**< dma_dma_chunk_done */
  kTopDarjeelingNoIbexPlicIrqIdDmaDmaError = 131, /**< dma_dma_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx0MbxReady = 132, /**< mbx0_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx0MbxAbort = 133, /**< mbx0_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx0MbxError = 134, /**< mbx0_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx1MbxReady = 135, /**< mbx1_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx1MbxAbort = 136, /**< mbx1_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx1MbxError = 137, /**< mbx1_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx2MbxReady = 138, /**< mbx2_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx2MbxAbort = 139, /**< mbx2_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx2MbxError = 140, /**< mbx2_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx3MbxReady = 141, /**< mbx3_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx3MbxAbort = 142, /**< mbx3_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx3MbxError = 143, /**< mbx3_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx4MbxReady = 144, /**< mbx4_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx4MbxAbort = 145, /**< mbx4_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx4MbxError = 146, /**< mbx4_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx5MbxReady = 147, /**< mbx5_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx5MbxAbort = 148, /**< mbx5_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx5MbxError = 149, /**< mbx5_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbx6MbxReady = 150, /**< mbx6_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbx6MbxAbort = 151, /**< mbx6_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbx6MbxError = 152, /**< mbx6_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbxJtagMbxReady = 153, /**< mbx_jtag_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbxJtagMbxAbort = 154, /**< mbx_jtag_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbxJtagMbxError = 155, /**< mbx_jtag_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbxPcie0MbxReady = 156, /**< mbx_pcie0_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbxPcie0MbxAbort = 157, /**< mbx_pcie0_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbxPcie0MbxError = 158, /**< mbx_pcie0_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdMbxPcie1MbxReady = 159, /**< mbx_pcie1_mbx_ready */
  kTopDarjeelingNoIbexPlicIrqIdMbxPcie1MbxAbort = 160, /**< mbx_pcie1_mbx_abort */
  kTopDarjeelingNoIbexPlicIrqIdMbxPcie1MbxError = 161, /**< mbx_pcie1_mbx_error */
  kTopDarjeelingNoIbexPlicIrqIdRaclCtrlRaclError = 162, /**< racl_ctrl_racl_error */
  kTopDarjeelingNoIbexPlicIrqIdAcRangeCheckDenyCntReached = 163, /**< ac_range_check_deny_cnt_reached */
  kTopDarjeelingNoIbexPlicIrqIdLast = 163, /**< \internal The Last Valid Interrupt ID. */
...
extern const top_darjeeling_no_ibex_plic_peripheral_t
    top_darjeeling_no_ibex_plic_interrupt_for_peripheral[164];
...
typedef enum top_darjeeling_no_ibex_alert_peripheral {
  ...
  kTopDarjeelingNoIbexAlertPeripheralRvTimer = 5, /**< rv_timer */
  kTopDarjeelingNoIbexAlertPeripheralOtpCtrl = 6, /**< otp_ctrl */
  kTopDarjeelingNoIbexAlertPeripheralLcCtrl = 7, /**< lc_ctrl */
  kTopDarjeelingNoIbexAlertPeripheralSpiHost0 = 8, /**< spi_host0 */
  kTopDarjeelingNoIbexAlertPeripheralPwrmgrAon = 9, /**< pwrmgr_aon */
  kTopDarjeelingNoIbexAlertPeripheralRstmgrAon = 10, /**< rstmgr_aon */
  kTopDarjeelingNoIbexAlertPeripheralClkmgrAon = 11, /**< clkmgr_aon */
  kTopDarjeelingNoIbexAlertPeripheralPinmuxAon = 12, /**< pinmux_aon */
  kTopDarjeelingNoIbexAlertPeripheralAonTimerAon = 13, /**< aon_timer_aon */
  kTopDarjeelingNoIbexAlertPeripheralSocProxy = 14, /**< soc_proxy */
  kTopDarjeelingNoIbexAlertPeripheralSramCtrlRetAon = 15, /**< sram_ctrl_ret_aon */
  kTopDarjeelingNoIbexAlertPeripheralRvDm = 16, /**< rv_dm */
  kTopDarjeelingNoIbexAlertPeripheralRvPlic = 17, /**< rv_plic */
  kTopDarjeelingNoIbexAlertPeripheralAes = 18, /**< aes */
  kTopDarjeelingNoIbexAlertPeripheralHmac = 19, /**< hmac */
  kTopDarjeelingNoIbexAlertPeripheralKmac = 20, /**< kmac */
  kTopDarjeelingNoIbexAlertPeripheralOtbn = 21, /**< otbn */
  kTopDarjeelingNoIbexAlertPeripheralKeymgrDpe = 22, /**< keymgr_dpe */
  kTopDarjeelingNoIbexAlertPeripheralCsrng = 23, /**< csrng */
  kTopDarjeelingNoIbexAlertPeripheralEntropySrc = 24, /**< entropy_src */
  kTopDarjeelingNoIbexAlertPeripheralEdn0 = 25, /**< edn0 */
  kTopDarjeelingNoIbexAlertPeripheralEdn1 = 26, /**< edn1 */
  kTopDarjeelingNoIbexAlertPeripheralSramCtrlMain = 27, /**< sram_ctrl_main */
  kTopDarjeelingNoIbexAlertPeripheralSramCtrlMbox = 28, /**< sram_ctrl_mbox */
  kTopDarjeelingNoIbexAlertPeripheralRomCtrl0 = 29, /**< rom_ctrl0 */
  kTopDarjeelingNoIbexAlertPeripheralRomCtrl1 = 30, /**< rom_ctrl1 */
  kTopDarjeelingNoIbexAlertPeripheralDma = 31, /**< dma */
  kTopDarjeelingNoIbexAlertPeripheralMbx0 = 32, /**< mbx0 */
  kTopDarjeelingNoIbexAlertPeripheralMbx1 = 33, /**< mbx1 */
  kTopDarjeelingNoIbexAlertPeripheralMbx2 = 34, /**< mbx2 */
  kTopDarjeelingNoIbexAlertPeripheralMbx3 = 35, /**< mbx3 */
  kTopDarjeelingNoIbexAlertPeripheralMbx4 = 36, /**< mbx4 */
  kTopDarjeelingNoIbexAlertPeripheralMbx5 = 37, /**< mbx5 */
  kTopDarjeelingNoIbexAlertPeripheralMbx6 = 38, /**< mbx6 */
  kTopDarjeelingNoIbexAlertPeripheralMbxJtag = 39, /**< mbx_jtag */
  kTopDarjeelingNoIbexAlertPeripheralMbxPcie0 = 40, /**< mbx_pcie0 */
  kTopDarjeelingNoIbexAlertPeripheralMbxPcie1 = 41, /**< mbx_pcie1 */
  kTopDarjeelingNoIbexAlertPeripheralSocDbgCtrl = 42, /**< soc_dbg_ctrl */
  kTopDarjeelingNoIbexAlertPeripheralRaclCtrl = 43, /**< racl_ctrl */
  kTopDarjeelingNoIbexAlertPeripheralAcRangeCheck = 44, /**< ac_range_check */
  kTopDarjeelingNoIbexAlertPeripheralLast = 44, /**< \internal Final Alert peripheral */
...
typedef enum top_darjeeling_no_ibex_alert_id {
  ...
  kTopDarjeelingNoIbexAlertIdRvTimerFatalFault = 4, /**< rv_timer_fatal_fault */
  kTopDarjeelingNoIbexAlertIdOtpCtrlFatalMacroError = 5, /**< otp_ctrl_fatal_macro_error */
  kTopDarjeelingNoIbexAlertIdOtpCtrlFatalCheckError = 6, /**< otp_ctrl_fatal_check_error */
  kTopDarjeelingNoIbexAlertIdOtpCtrlFatalBusIntegError = 7, /**< otp_ctrl_fatal_bus_integ_error */
  kTopDarjeelingNoIbexAlertIdOtpCtrlFatalPrimOtpAlert = 8, /**< otp_ctrl_fatal_prim_otp_alert */
  kTopDarjeelingNoIbexAlertIdOtpCtrlRecovPrimOtpAlert = 9, /**< otp_ctrl_recov_prim_otp_alert */
  kTopDarjeelingNoIbexAlertIdLcCtrlFatalProgError = 10, /**< lc_ctrl_fatal_prog_error */
  kTopDarjeelingNoIbexAlertIdLcCtrlFatalStateError = 11, /**< lc_ctrl_fatal_state_error */
  kTopDarjeelingNoIbexAlertIdLcCtrlFatalBusIntegError = 12, /**< lc_ctrl_fatal_bus_integ_error */
  kTopDarjeelingNoIbexAlertIdSpiHost0FatalFault = 13, /**< spi_host0_fatal_fault */
  kTopDarjeelingNoIbexAlertIdPwrmgrAonFatalFault = 14, /**< pwrmgr_aon_fatal_fault */
  kTopDarjeelingNoIbexAlertIdRstmgrAonFatalFault = 15, /**< rstmgr_aon_fatal_fault */
  kTopDarjeelingNoIbexAlertIdRstmgrAonFatalCnstyFault = 16, /**< rstmgr_aon_fatal_cnsty_fault */
  kTopDarjeelingNoIbexAlertIdClkmgrAonRecovFault = 17, /**< clkmgr_aon_recov_fault */
  kTopDarjeelingNoIbexAlertIdClkmgrAonFatalFault = 18, /**< clkmgr_aon_fatal_fault */
  kTopDarjeelingNoIbexAlertIdPinmuxAonFatalFault = 19, /**< pinmux_aon_fatal_fault */
  kTopDarjeelingNoIbexAlertIdAonTimerAonFatalFault = 20, /**< aon_timer_aon_fatal_fault */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertIntg = 21, /**< soc_proxy_fatal_alert_intg */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal0 = 22, /**< soc_proxy_fatal_alert_external_0 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal1 = 23, /**< soc_proxy_fatal_alert_external_1 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal2 = 24, /**< soc_proxy_fatal_alert_external_2 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal3 = 25, /**< soc_proxy_fatal_alert_external_3 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal4 = 26, /**< soc_proxy_fatal_alert_external_4 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal5 = 27, /**< soc_proxy_fatal_alert_external_5 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal6 = 28, /**< soc_proxy_fatal_alert_external_6 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal7 = 29, /**< soc_proxy_fatal_alert_external_7 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal8 = 30, /**< soc_proxy_fatal_alert_external_8 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal9 = 31, /**< soc_proxy_fatal_alert_external_9 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal10 = 32, /**< soc_proxy_fatal_alert_external_10 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal11 = 33, /**< soc_proxy_fatal_alert_external_11 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal12 = 34, /**< soc_proxy_fatal_alert_external_12 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal13 = 35, /**< soc_proxy_fatal_alert_external_13 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal14 = 36, /**< soc_proxy_fatal_alert_external_14 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal15 = 37, /**< soc_proxy_fatal_alert_external_15 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal16 = 38, /**< soc_proxy_fatal_alert_external_16 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal17 = 39, /**< soc_proxy_fatal_alert_external_17 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal18 = 40, /**< soc_proxy_fatal_alert_external_18 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal19 = 41, /**< soc_proxy_fatal_alert_external_19 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal20 = 42, /**< soc_proxy_fatal_alert_external_20 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal21 = 43, /**< soc_proxy_fatal_alert_external_21 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal22 = 44, /**< soc_proxy_fatal_alert_external_22 */
  kTopDarjeelingNoIbexAlertIdSocProxyFatalAlertExternal23 = 45, /**< soc_proxy_fatal_alert_external_23 */
  kTopDarjeelingNoIbexAlertIdSocProxyRecovAlertExternal0 = 46, /**< soc_proxy_recov_alert_external_0 */
  kTopDarjeelingNoIbexAlertIdSocProxyRecovAlertExternal1 = 47, /**< soc_proxy_recov_alert_external_1 */
  kTopDarjeelingNoIbexAlertIdSocProxyRecovAlertExternal2 = 48, /**< soc_proxy_recov_alert_external_2 */
  kTopDarjeelingNoIbexAlertIdSocProxyRecovAlertExternal3 = 49, /**< soc_proxy_recov_alert_external_3 */
  kTopDarjeelingNoIbexAlertIdSramCtrlRetAonFatalError = 50, /**< sram_ctrl_ret_aon_fatal_error */
  kTopDarjeelingNoIbexAlertIdRvDmFatalFault = 51, /**< rv_dm_fatal_fault */
  kTopDarjeelingNoIbexAlertIdRvPlicFatalFault = 52, /**< rv_plic_fatal_fault */
  kTopDarjeelingNoIbexAlertIdAesRecovCtrlUpdateErr = 53, /**< aes_recov_ctrl_update_err */
  kTopDarjeelingNoIbexAlertIdAesFatalFault = 54, /**< aes_fatal_fault */
  kTopDarjeelingNoIbexAlertIdHmacFatalFault = 55, /**< hmac_fatal_fault */
  kTopDarjeelingNoIbexAlertIdKmacRecovOperationErr = 56, /**< kmac_recov_operation_err */
  kTopDarjeelingNoIbexAlertIdKmacFatalFaultErr = 57, /**< kmac_fatal_fault_err */
  kTopDarjeelingNoIbexAlertIdOtbnFatal = 58, /**< otbn_fatal */
  kTopDarjeelingNoIbexAlertIdOtbnRecov = 59, /**< otbn_recov */
  kTopDarjeelingNoIbexAlertIdKeymgrDpeRecovOperationErr = 60, /**< keymgr_dpe_recov_operation_err */
  kTopDarjeelingNoIbexAlertIdKeymgrDpeFatalFaultErr = 61, /**< keymgr_dpe_fatal_fault_err */
  kTopDarjeelingNoIbexAlertIdCsrngRecovAlert = 62, /**< csrng_recov_alert */
  kTopDarjeelingNoIbexAlertIdCsrngFatalAlert = 63, /**< csrng_fatal_alert */
  kTopDarjeelingNoIbexAlertIdEntropySrcRecovAlert = 64, /**< entropy_src_recov_alert */
  kTopDarjeelingNoIbexAlertIdEntropySrcFatalAlert = 65, /**< entropy_src_fatal_alert */
  kTopDarjeelingNoIbexAlertIdEdn0RecovAlert = 66, /**< edn0_recov_alert */
  kTopDarjeelingNoIbexAlertIdEdn0FatalAlert = 67, /**< edn0_fatal_alert */
  kTopDarjeelingNoIbexAlertIdEdn1RecovAlert = 68, /**< edn1_recov_alert */
  kTopDarjeelingNoIbexAlertIdEdn1FatalAlert = 69, /**< edn1_fatal_alert */
  kTopDarjeelingNoIbexAlertIdSramCtrlMainFatalError = 70, /**< sram_ctrl_main_fatal_error */
  kTopDarjeelingNoIbexAlertIdSramCtrlMboxFatalError = 71, /**< sram_ctrl_mbox_fatal_error */
  kTopDarjeelingNoIbexAlertIdRomCtrl0Fatal = 72, /**< rom_ctrl0_fatal */
  kTopDarjeelingNoIbexAlertIdRomCtrl1Fatal = 73, /**< rom_ctrl1_fatal */
  kTopDarjeelingNoIbexAlertIdDmaFatalFault = 74, /**< dma_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx0FatalFault = 75, /**< mbx0_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx0RecovFault = 76, /**< mbx0_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbx1FatalFault = 77, /**< mbx1_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx1RecovFault = 78, /**< mbx1_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbx2FatalFault = 79, /**< mbx2_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx2RecovFault = 80, /**< mbx2_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbx3FatalFault = 81, /**< mbx3_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx3RecovFault = 82, /**< mbx3_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbx4FatalFault = 83, /**< mbx4_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx4RecovFault = 84, /**< mbx4_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbx5FatalFault = 85, /**< mbx5_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx5RecovFault = 86, /**< mbx5_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbx6FatalFault = 87, /**< mbx6_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbx6RecovFault = 88, /**< mbx6_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbxJtagFatalFault = 89, /**< mbx_jtag_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbxJtagRecovFault = 90, /**< mbx_jtag_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbxPcie0FatalFault = 91, /**< mbx_pcie0_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbxPcie0RecovFault = 92, /**< mbx_pcie0_recov_fault */
  kTopDarjeelingNoIbexAlertIdMbxPcie1FatalFault = 93, /**< mbx_pcie1_fatal_fault */
  kTopDarjeelingNoIbexAlertIdMbxPcie1RecovFault = 94, /**< mbx_pcie1_recov_fault */
  kTopDarjeelingNoIbexAlertIdSocDbgCtrlFatalFault = 95, /**< soc_dbg_ctrl_fatal_fault */
  kTopDarjeelingNoIbexAlertIdSocDbgCtrlRecovCtrlUpdateErr = 96, /**< soc_dbg_ctrl_recov_ctrl_update_err */
  kTopDarjeelingNoIbexAlertIdRaclCtrlFatalFault = 97, /**< racl_ctrl_fatal_fault */
  kTopDarjeelingNoIbexAlertIdRaclCtrlRecovCtrlUpdateErr = 98, /**< racl_ctrl_recov_ctrl_update_err */
  kTopDarjeelingNoIbexAlertIdAcRangeCheckRecovCtrlUpdateErr = 99, /**< ac_range_check_recov_ctrl_update_err */
  kTopDarjeelingNoIbexAlertIdAcRangeCheckFatalFault = 100, /**< ac_range_check_fatal_fault */
  kTopDarjeelingNoIbexAlertIdLast = 100, /**< \internal The Last Valid Alert ID. */
...
extern const top_darjeeling_no_ibex_alert_peripheral_t
    top_darjeeling_no_ibex_alert_for_peripheral[101];
...
#endif  // OPENTITAN_SW_AUTOGEN_TOP_DARJEELING_NO_IBEX_H_
