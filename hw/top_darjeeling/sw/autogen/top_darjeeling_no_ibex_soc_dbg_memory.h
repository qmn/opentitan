...
#ifndef OPENTITAN_SW_AUTOGEN_TOP_DARJEELING_NO_IBEX_SOC_DBG_MEMORY_H_
#define OPENTITAN_SW_AUTOGEN_TOP_DARJEELING_NO_IBEX_SOC_DBG_MEMORY_H_
...
/**
 * Peripheral base address for dbg device on rv_dm in top darjeeling_no_ibex.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_BASE_ADDR 0x0

/**
 * Peripheral size for dbg device on rv_dm in top darjeeling_no_ibex.
 *
 * This is the size (in bytes) of the peripheral's reserved memory area. All
 * memory-mapped registers associated with this peripheral should have an
 * address between #TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_BASE_ADDR and
 * `TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_BASE_ADDR + TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_SIZE_BYTES`.
 */
#define TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_SIZE_BYTES 0x200
/**
...
#endif  // OPENTITAN_SW_AUTOGEN_TOP_DARJEELING_NO_IBEX_SOC_DBG_MEMORY_H_
