...
package top_darjeeling_no_ibex_soc_dbg_pkg;
   ...
   */
  parameter int unsigned TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_BASE_ADDR = 32'h0;

  /**
   * Peripheral size in bytes for dbg device on rv_dm in top darjeeling_no_ibex.
   */
  parameter int unsigned TOP_DARJEELING_NO_IBEX_SOC_DBG_RV_DM_DBG_SIZE_BYTES = 32'h200;
