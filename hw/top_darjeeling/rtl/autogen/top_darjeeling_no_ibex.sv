...
module top_darjeeling_no_ibex #(
  ...
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_rv_dm__sba_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_rv_dm__sba_rsp;
  ...
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_peri_no_ibex_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_peri_no_ibex_rsp;
  ...
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_dma__host_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_dma__host_rsp;
  tlul_pkg::tl_h2d_t       mbx0_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx0_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx0__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx0__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx1_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx1_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx1__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx1__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx2_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx2_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx2__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx2__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx3_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx3_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx3__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx3__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx4_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx4_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx4__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx4__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx5_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx5_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx5__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx5__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx6_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx6_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx6__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx6__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx_jtag_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx_jtag_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx_jtag__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx_jtag__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx_pcie0_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx_pcie0_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx_pcie0__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx_pcie0__sram_rsp;
  tlul_pkg::tl_h2d_t       mbx_pcie1_core_tl_d_req;
  tlul_pkg::tl_d2h_t       mbx_pcie1_core_tl_d_rsp;
  tlul_pkg::tl_h2d_t       main_no_ibex_tl_mbx_pcie1__sram_req;
  tlul_pkg::tl_d2h_t       main_no_ibex_tl_mbx_pcie1__sram_rsp;
...
// pragma coverage on
  ...
  rv_dm #(
    ...
    .TlulHostUserRsvdBits(RvDmTlulHostUserRsvdBits)
      ...
      .racl_policies_i(top_racl_pkg::RACL_POLICY_VEC_DEFAULT),
      .racl_error_o(),
      .sba_tl_h_o(main_no_ibex_tl_rv_dm__sba_req),
      .sba_tl_h_i(main_no_ibex_tl_rv_dm__sba_rsp),
  ...
  dma #(
    ...
    .OtAgentId(DmaOtAgentId)
      ...
      .racl_policies_i(top_racl_pkg::RACL_POLICY_VEC_DEFAULT),
      .racl_error_o(),
      .host_tl_h_o(main_no_ibex_tl_dma__host_req),
      .host_tl_h_i(main_no_ibex_tl_dma__host_rsp),
      .tl_d_i(dma_tl_d_req),
      .tl_d_o(dma_tl_d_rsp),
      .scanmode_i,
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx0__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx0__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx1__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx1__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx2__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx2__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx3__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx3__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx4__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx4__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx5__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx5__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx6__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx6__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx_jtag__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx_jtag__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx_pcie0__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx_pcie0__sram_rsp),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .sram_tl_h_o(main_no_ibex_tl_mbx_pcie1__sram_req),
      .sram_tl_h_i(main_no_ibex_tl_mbx_pcie1__sram_rsp),
  ...
  // TL-UL Crossbar
  xbar_main_no_ibex u_xbar_main_no_ibex (
    ...
    // port: tl_rv_dm__sba
    .tl_rv_dm__sba_i(main_no_ibex_tl_rv_dm__sba_req),
    .tl_rv_dm__sba_o(main_no_ibex_tl_rv_dm__sba_rsp),

    // port: tl_dma__host
    .tl_dma__host_i(main_no_ibex_tl_dma__host_req),
    .tl_dma__host_o(main_no_ibex_tl_dma__host_rsp),

    // port: tl_mbx0__sram
    .tl_mbx0__sram_i(main_no_ibex_tl_mbx0__sram_req),
    .tl_mbx0__sram_o(main_no_ibex_tl_mbx0__sram_rsp),

    // port: tl_mbx1__sram
    .tl_mbx1__sram_i(main_no_ibex_tl_mbx1__sram_req),
    .tl_mbx1__sram_o(main_no_ibex_tl_mbx1__sram_rsp),

    // port: tl_mbx2__sram
    .tl_mbx2__sram_i(main_no_ibex_tl_mbx2__sram_req),
    .tl_mbx2__sram_o(main_no_ibex_tl_mbx2__sram_rsp),

    // port: tl_mbx3__sram
    .tl_mbx3__sram_i(main_no_ibex_tl_mbx3__sram_req),
    .tl_mbx3__sram_o(main_no_ibex_tl_mbx3__sram_rsp),

    // port: tl_mbx4__sram
    .tl_mbx4__sram_i(main_no_ibex_tl_mbx4__sram_req),
    .tl_mbx4__sram_o(main_no_ibex_tl_mbx4__sram_rsp),

    // port: tl_mbx5__sram
    .tl_mbx5__sram_i(main_no_ibex_tl_mbx5__sram_req),
    .tl_mbx5__sram_o(main_no_ibex_tl_mbx5__sram_rsp),

    // port: tl_mbx6__sram
    .tl_mbx6__sram_i(main_no_ibex_tl_mbx6__sram_req),
    .tl_mbx6__sram_o(main_no_ibex_tl_mbx6__sram_rsp),

    // port: tl_mbx_jtag__sram
    .tl_mbx_jtag__sram_i(main_no_ibex_tl_mbx_jtag__sram_req),
    .tl_mbx_jtag__sram_o(main_no_ibex_tl_mbx_jtag__sram_rsp),

    // port: tl_mbx_pcie0__sram
    .tl_mbx_pcie0__sram_i(main_no_ibex_tl_mbx_pcie0__sram_req),
    .tl_mbx_pcie0__sram_o(main_no_ibex_tl_mbx_pcie0__sram_rsp),

    // port: tl_mbx_pcie1__sram
    .tl_mbx_pcie1__sram_i(main_no_ibex_tl_mbx_pcie1__sram_req),
    .tl_mbx_pcie1__sram_o(main_no_ibex_tl_mbx_pcie1__sram_rsp),
    ...
    // port: tl_peri_no_ibex
    .tl_peri_no_ibex_o(main_no_ibex_tl_peri_no_ibex_req),
    .tl_peri_no_ibex_i(main_no_ibex_tl_peri_no_ibex_rsp),
  ...
  xbar_peri_no_ibex u_xbar_peri_no_ibex (
    .clk_peri_i (clkmgr_aon_clocks.clk_io_div4_infra),
    .rst_peri_ni (rstmgr_aon_resets.rst_lc_io_div4_n[rstmgr_pkg::Domain0Sel]),

    // port: tl_main_no_ibex
    .tl_main_no_ibex_i(main_no_ibex_tl_peri_no_ibex_req),
    .tl_main_no_ibex_o(main_no_ibex_tl_peri_no_ibex_rsp),
